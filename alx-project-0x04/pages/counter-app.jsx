...
const CounterApp: React.FC = () => {
    ...
    return (
    <>
        <div className='min-h-screen bg-linear-to-r from-yellow-400
         to-pink-500 flex flex-col justify-center items-center text-white'>
            ...
            <p className='text-lg font-medium mb-4'>
                Current count: {count} {count===0? "No Clicks yet!" : count%10===0?"You are on fire":""};
            ...
            <p className='mt-8 text-sm text-white opacity-75'>
                Keep Clicking, who knows what happens at 100?</p>
        </div>
    </>
  )
}
